...
card = '{"type":"AdaptiveCard","$schema":"http://adaptivecards.io/schemas/adaptive-card.json","version":"1.2","body":[{"type":"Image","url":"{SERVER_BANNER}","horizontalAlignment":"Center"},{"type":"TextBlock","text":"{SERVER_TITLE}","wrap":true,"horizontalAlignment":"Center","separator":true,"height":"stretch","fontType":"Default","size":"Large","weight":"Bolder","color":"Light"},{"type":"TextBlock","text":"{DESCRIPTION}","wrap":true,"fontType":"Default","horizontalAlignment":"Center","color":"Light","size":"Medium"}{WORLDS},{"type":"ActionSet","actions":[{"type":"Action.OpenUrl","title":"Kliknij w panel a zostaniesz przekierowany na DISCORD\'s Discord","style":"destructive","iconUrl":"https://cdn.discordapp.com/attachments/896789230292979772/899712806482477076/Avenlogo2.png","url":"https://discord.gg/jc4sfFwMXe"}]}]}'
-- Replace --{WORLDS}-- with:
